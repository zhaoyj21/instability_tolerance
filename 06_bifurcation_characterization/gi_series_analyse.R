library(rEDM)
raw_time <- read.table("ts_gi_0072.txt", header=F)[14500:16500,1]
raw_time_series <- read.table("ts_gi_0072.txt", header=F)[14500:16500,2]
...
plot(0,0, col="white", ylim=c(0, 1.5), xlim=c(0, 3500), las=0, cex.axis=1.65, cex.lab=1.75, main="", xlab="", ylab="| DEV |")

points(c(0,3500), c(1,1), col="gray", type="l", lwd=3, lty=2)

mat = cbind(result[1:96,1], result[1:96,2], 1:96)
n = 255
...
points(result[1:96,1], result[1:96,2], lty=1, lwd=5, type="p", cex=0.5, pch=20, col=cols)

write.table(result, "C:/Users/Administrator/Desktop/dev_gi_0072.txt", append = FALSE, sep = " ", dec = ".",
...
write.table(mat, "C:/Users/Administrator/Desktop/class_gi_0072.txt", append = FALSE, sep = " ", dec = ".",
            row.names = FALSE, col.names = FALSE)